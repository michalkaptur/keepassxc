...
bool Crypto::testAes256Cbc()
{
    ...
    SymmetricCipher aes256Encrypt(SymmetricCipher::Algorithm::Aes256, SymmetricCipher::Mode::Cbc, SymmetricCipher::Direction::Encrypt);
    ...
    SymmetricCipher aes256Decrypt(SymmetricCipher::Algorithm::Aes256, SymmetricCipher::Mode::Cbc, SymmetricCipher::Direction::Decrypt);
...
bool Crypto::testAes256Ecb()
{
    ...
    SymmetricCipher aes256Encrypt(SymmetricCipher::Algorithm::Aes256, SymmetricCipher::Mode::Ecb, SymmetricCipher::Direction::Encrypt);
    if (!aes256Encrypt.init(key, iv)) {
        raiseError(aes256Encrypt.errorString());
        return false;
    }
    ...
    SymmetricCipher aes256Decrypt(SymmetricCipher::Algorithm::Aes256, SymmetricCipher::Mode::Ecb, SymmetricCipher::Direction::Decrypt);
    if (!aes256Decrypt.init(key, iv)) {
        raiseError(aes256Decrypt.errorString());
        return false;
    }
...
bool Crypto::testTwofish()
{
    ...
    SymmetricCipher twofishEncrypt(SymmetricCipher::Algorithm::Twofish, SymmetricCipher::Mode::Cbc, SymmetricCipher::Direction::Encrypt);
    ...
    SymmetricCipher twofishDecrypt(SymmetricCipher::Algorithm::Twofish, SymmetricCipher::Mode::Cbc, SymmetricCipher::Direction::Decrypt);
...
bool Crypto::testSalsa20()
{
    ...
    SymmetricCipher salsa20Stream(SymmetricCipher::Algorithm::Salsa20, SymmetricCipher::Mode::Stream,
