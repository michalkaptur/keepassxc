...
Request::Request():
    ...
    m_cipher(SymmetricCipher::Aes256, SymmetricCipher::Cbc, SymmetricCipher::Direction::Decrypt)
{
  m_cipher.init();
}
...
Response::Response(const Request &request, QString hash):
    ...
    m_hash(hash),
    m_cipher(SymmetricCipher::Aes256, SymmetricCipher::Cbc, SymmetricCipher::Direction::Encrypt)
{
  m_cipher.init();
}
