...
{
    CryptoHash cryptoHash1(CryptoHash::Algorithm::Sha256);
    ...
    QByteArray result2 = CryptoHash::hash(source2, CryptoHash::Algorithm::Sha256);
    QCOMPARE(result2, QByteArray::fromHex("0b56e5f65263e747af4a833bd7dd7ad26a64d7a4de7c68e52364893dca0766b4"));

    CryptoHash cryptoHash3(CryptoHash::Algorithm::Sha256);
